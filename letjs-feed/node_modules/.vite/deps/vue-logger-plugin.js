...
// node_modules/vue-logger-plugin/dist/logger.js
var require_logger = __commonJS({
  "node_modules/vue-logger-plugin/dist/logger.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.useLogger = exports.createLogger = exports.VueLogger = void 0;
    var vue_1 = require_vue();
    var isProduction = false;
    var loggerSymbol = Symbol("vue-logger-plugin");
    ...
    var defaultOptions = {
      ...
      level: "debug",
      callerInfo: false,
      prefixFormat: ({ level, caller }) => caller ? `[${level.toUpperCase()}] [${caller === null || caller === void 0 ? void 0 : caller.fileName}:${caller === null || caller === void 0 ? void 0 : caller.functionName}:${caller === null || caller === void 0 ? void 0 : caller.lineNumber}]` : `[${level.toUpperCase()}]`
    };
    var VueLogger = class {
      constructor(options) {
        this.apply(options);
      ...
      debug(...args) {
        this.invoke("debug", ...args).then(() => {
        }).catch(() => {
        });
      }
      info(...args) {
        this.invoke("info", ...args).then(() => {
        }).catch(() => {
        });
      }
      warn(...args) {
        this.invoke("warn", ...args).then(() => {
        }).catch(() => {
        });
      }
      error(...args) {
        this.invoke("error", ...args).then(() => {
        }).catch(() => {
        });
      }
      log(...args) {
        this.invoke("log", ...args).then(() => {
        }).catch(() => {
        });
      }
      async invoke(level, ...args) {
        if (this._options.enabled && levels.indexOf(level) >= levels.indexOf(this._options.level)) {
          const caller = this._options.callerInfo ? this.getCallerInfo() : void 0;
...
// node_modules/vue-logger-plugin/dist/hooks.js
var require_hooks = __commonJS({
  "node_modules/vue-logger-plugin/dist/hooks.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/vue-logger-plugin/dist/index.js
var require_dist = __commonJS({
  "node_modules/vue-logger-plugin/dist/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "VueLogger", { enumerable: true, get: function() {
      return logger_1.VueLogger;
    } });
    ...
    Object.defineProperty(exports, "useLogger", { enumerable: true, get: function() {
      return logger_1.useLogger;
    } });
    var hooks_1 = require_hooks();
    Object.defineProperty(exports, "StringifyObjectsHook", { enumerable: true, get: function() {
      return hooks_1.StringifyObjectsHook;
    } });
    Object.defineProperty(exports, "StringifyAndParseObjectsHook", { enumerable: true, get: function() {
      return hooks_1.StringifyAndParseObjectsHook;
    } });
  }
});

// dep:vue-logger-plugin
var vue_logger_plugin_default = require_dist();
export {
  vue_logger_plugin_default as default
};
//# sourceMappingURL=vue-logger-plugin.js.map
